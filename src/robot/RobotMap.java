...
public class RobotMap {
	 ...
	 * the left motor port
	 */
	public final char LEFT_MOTOR = 'A';
	
	/**
	 * the right motor port
	 */
	public final char RIGHT_MOTOR = 'D';
	
	/**
	 * the motor port for the motor that controls the ultrasonic sensor
	 */
	public final char ULTRASONIC_MOTOR = 'B';
	 ...
	 */
	public final Port LEFT_COLOR = SensorPort.S1;
	
	/**
	 * port for the right color sensor
	 */
	public final Port RIGHT_COLOR = SensorPort.S4;
	
	/**
	 * port for the ultrasonic sensor
	 */
	public final Port ULTRASONIC = SensorPort.S3;
	...
	public RobotMap(String input) {
		...
		this.PATH_PROPERTIES = new int[1][1];//I HAVE NO IDEA WHAT THIS DOES
